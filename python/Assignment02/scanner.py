...
TRANSITION_MATRIX = [
    ...
    [     1,  7,VAR,VAR,  1,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7, 7,   7,  7,  7,VAR,VAR,VAR,VAR,VAR,VAR,  7], # state 1 - recieved undercase letter 
    [     2,CNT,CNT,CNT,  1,CNT,CNT,CNT,CNT,CNT,CNT,CNT,CNT,CNT,  7,  7,  7, 7,   7,  7,  7,CNT,CNT,CNT,CNT,CNT,CNT,  7], # state 2 - recieved uppercase letter
